...
public class jdbcEg1 {
		...
		//dml
		static void dataManipulation(Connection establishConn , Statement stmt) 
				throws SQLException 
		{

			int noOfRowsInserted = stmt.executeUpdate("INSERT INTO ashwaq.learners VALUES('dummy' , 'dummy1')");
			if(noOfRowsInserted > 0)
				System.out.println(noOfRowsInserted +" inserted successfully");
			else  
				System.out.println(noOfRowsInserted +"not inserted successfully");
		}
			...
			if(noOfRowsDeleted > 0)
				...
				System.out.println(noOfRowsDeleted +"not updated successfully");
		}
		*/
